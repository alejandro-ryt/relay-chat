...
export const updateUser = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        throw new ErrorHandler(ERROR.ERROR_UPDATING_USER, StatusCodes.SERVICE_UNAVAILABLE);
    }
  };
...
export const deleteUser = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    throw new ErrorHandler(ERROR.ERROR_DELETING_USER, StatusCodes.SERVICE_UNAVAILABLE);
  }
};
